--This table contains algo conversions using order completed as the event where the conversion event is within 7 days of the impression
...
SELECT DISTINCT COUNTRY,
    ...
    PRODUCT_RECOMMENDATION_TYPE
FROM RECENT_ORDERS
WHERE PRODUCT_RECOMMENDATION_TYPE IN ('CROSS_SELL_UP_SELL', 'QUICK_ORDER', 'FORGOTTEN_ITEMS')
