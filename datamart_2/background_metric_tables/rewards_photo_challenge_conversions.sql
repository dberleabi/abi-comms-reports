--This table contains photo challenge conversions using challenge submitted as the event where the conversion event is within 2 days of the impression
...
WHERE CAMPAIGN_TYPE = 'Rewards'
  AND CAMPAIGN_SUBTYPE = 'Photo Challenge'
),
...
AND EXECUTION_METHOD LIKE '%PHOTO%'
)
